// ====================================
// src/components/admin/media/MediaPhotos.jsx - Gestión de fotografías con funcionalidad de fotoJoven
// ====================================
import React, { useState, useEffect, useCallback } from 'react';
import mediaService from '../../../services/mediaService';
import memorialService from '../../../services/memorialService';

const MediaPhotos = ({ selectedMemorial, onStatsUpdate }) => {
  ...
  const loadPhotos = async () => {
    try {
      ...
      console.log('📸 MediaPhotos - Respuesta API:', response);
      
      // Extraer el array de media correctamente
      const photosArray = response.data?.media || response.media || [];
      console.log('📸 MediaPhotos - Photos array:', photosArray);
  ...
  const updateStats = useCallback(() => {
    ...
    console.log('📊 Photos Stats calculados:', { totalFotos });
