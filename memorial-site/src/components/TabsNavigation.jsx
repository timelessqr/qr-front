      ...
      <div className="container mx-auto px-2">
        <nav className="flex justify-center overflow-x-auto">
          <button 
            ...
            className={`px-3 sm:px-6 md:px-8 py-4 sm:py-5 font-medium text-xs sm:text-sm transition-colors duration-200 flex flex-col items-center focus:outline-none whitespace-nowrap min-w-0 flex-1 sm:flex-none ${
              activeTab === 'historia' 
